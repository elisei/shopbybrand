 ...
 */
namespace O2TI\ShopByBrand\Model\ResourceModel\Sitemap;

use O2TI\ShopByBrand\Api\Data\PageInterface;
use O2TI\ShopByBrand\Api\GetUtilityPageIdentifiersInterface;
...
class Brand extends AbstractDb
{
    ...
    public function getCollection($storeId)
    {
        ...
        $select = $this->getConnection()->select()->from(
            ...
            ['store_table' => $this->getTable('brand_page_store')],
