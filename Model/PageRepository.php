...
use O2TI\ShopByBrand\Api\Data;
use O2TI\ShopByBrand\Api\PageRepositoryInterface;
...
use O2TI\ShopByBrand\Model\ResourceModel\Page as ResourcePage;
use O2TI\ShopByBrand\Model\ResourceModel\Page\CollectionFactory as PageCollectionFactory;
...
class PageRepository implements PageRepositoryInterface
{
    ...
    /**
     * @var \O2TI\ShopByBrand\Api\Data\PageInterfaceFactory
     */
     ...
     * Save Page data
     *
     * @param \O2TI\ShopByBrand\Api\Data\PageInterface|Page $page
     * @return Page
    ...
    {
        $page = $this->pageFactory->create();
        $page->load($attributeId, 'attribute_id');
    ...
    {
        /** @var \O2TI\ShopByBrand\Model\ResourceModel\Page\Collection $collection */
    ...
    private function getCollectionProcessor()
    {
        if (!$this->collectionProcessor) {
            $this->collectionProcessor = \Magento\Framework\App\ObjectManager::getInstance()->get(
                'O2TI\ShopByBrand\Model\Api\SearchCriteria\PageCollectionProcessor'
            );
        }
