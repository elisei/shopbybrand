...
use O2TI\ShopByBrand\Helper\Page as PageHelper;
...
class Page extends AbstractModel implements PageInterface, IdentityInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'brand_page';
    ...
    {
        $this->_init(\O2TI\ShopByBrand\Model\ResourceModel\Page::class);
    }
    ...
    /**
     * Prepare page's statuses, available event brand_page_get_available_statuses to customize statuses.
     *
     * @return array
     */
    ...
    /**
     * Get Attribute id to manufeacture
     *
     * @return string
     */
    ...
    {
        return $this->setData(self::IS_FEATURED, $ifFeatured);
    }
