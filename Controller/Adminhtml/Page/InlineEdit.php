...
use O2TI\ShopByBrand\Api\PageRepositoryInterface as PageRepository;
use Magento\Framework\App\Action\HttpPostActionInterface;
use Magento\Framework\Controller\Result\JsonFactory;
use O2TI\ShopByBrand\Api\Data\PageInterface;

/**
 * Brand page grid inline edit controller
 *
...
class InlineEdit extends \Magento\Backend\App\Action implements HttpPostActionInterface
{
    ...
    /**
     * @var \O2TI\ShopByBrand\Controller\Adminhtml\Page\PostDataProcessor
     */
    ...
    public function execute()
    {
        ...
        foreach (array_keys($postItems) as $pageId) {
            ...
            try {
                ...
                $this->setBrandPageData($page, $extendedPageData, $pageData);
     ...
     * @return void
     */
    protected function validatePost(array $pageData, \O2TI\ShopByBrand\Model\Page $page, &$error, array &$messages)
    {
     ...
     * @return $this
     */
    public function setBrandPageData(\O2TI\ShopByBrand\Model\Page $page, array $extendedPageData, array $pageData)
    {
